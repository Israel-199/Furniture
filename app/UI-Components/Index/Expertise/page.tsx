...
const expertiseData = [
    {
        ...
        desc:"this renovation and modeling",
        image:expertise1,
    },
        {
        id:"2",
        ...
        <div className="px-[8%] lg:px-[12%] md:py-50 pt-10 pb-10 md:pb-[25%] relative">
          <div className="flex flex-col gap-10">
            ...
            <div className="w-full lg:w-2/3">
               <h1 className="CalSans text-4xl text-white md:text-7xl">Curating the perfect<span className="text-(--prim)"> pieces to complete</span>your space</h1>
            </div>
         </div>
